...
def calculation_total_income_tax(
    ...
    (
        total_cant_muni_church,
        tax_canton,
        tax_commune,
        tax_church,
    ) = calculation_cantonal_municipal_church_tax(
        tax_multiplicators_cantonal_municipal,
    ...
    total_tax = federal_tax + total_cant_muni_church
    ...
    return {
        ...
        "total_cantonal_municipal_church_tax": total_cant_muni_church,
        "total_tax": total_tax,
    }
